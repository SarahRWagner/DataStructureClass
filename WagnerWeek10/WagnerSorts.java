/*
   Sarah Wagner Week 10 Assignment Question 1 & 10
   
   Question 1:
      A) My approach to counting the amount of swaps is to create an int
         variable that I will put as a global variable so all methods can see it. I increment the count
         in the swap method, so then whenever any of the sort methods run they have a count of 
      B) In the swap class you will find the extra variable I added.
      C) When printed it returns 49 swaps, just as the book stated.
   Question 10: 
      A-D results:
      
       The number of comparisons in a Selection Sort is: 1225
    The number of swaps in a Selection Sort is: 49
    
    The number of comparisons in a Bubble Sort is: 2450 
    The number of swaps in a Bubble Sort is: 49
    
    The number of comparisons in a ShortBubble Sort is: 2499
    The number of swaps in a ShortBubble Sort is: 49
    
    The number of comparisons in an Insertion Sort is: 2499
    The number of swaps in an InsertionSort is: 49
   
*/
import java.util.*;
import java.text.DecimalFormat;

public class WagnerSorts
{
  static final int SIZE = 50;            // size of array to be sorted
  static int[] values = new int[SIZE];   // values to be sorted
  static int count = 0; // count variable for all methods to see
  static int compCount = 0; // comparsion counter
  ...
  // Swaps the integers at locations index1 and index2 of the values array. 
  {
    ...
    values[index2] = temp;
    count++; // Count the amount of swaps
  }
  ...
  // Sorts the values array using the selection sort algorithm.
  {
    ...
    System.out.println("The number of comparisons in a Selection Sort is: " + compCount);
    System.out.println("The number of swaps in a Selection Sort is: " + count); // Check swap number
  }
  ...
  // Sorts the values array using the bubble sort algorithm.
  {
    ...
    System.out.println("\nThe number of comparisons in a Bubble Sort is: " + compCount);
    System.out.println("The number of swaps in a Bubble Sort is: " + count);
  }
  ...
  // The process stops as soon as values is sorted.
  {
    ...
    System.out.println("\nThe number of comparisons in a ShortBubble Sort is: " + compCount);
    System.out.println("The number of swaps in a ShortBubble Sort is: " + count);
  }
  ...
  // Sorts the values array using the insertion sort algorithm.
  {
   ...
   System.out.println("\nThe number of comparisons in an Insertion Sort is: " + compCount);
   System.out.println("The number of swaps in an InsertionSort is: " + count);
  }
